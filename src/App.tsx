...
const UI_TEXT = {
  en: {
    ...
    footer: {
      tagline: 'AGGREGATING DATA STREAMS',
...
const NAV_ITEMS = ['home', 'forecast', 'satellite', 'regional', 'environment', 'research', 'community', 'videos', 'access'];
...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen text-white selection:bg-sky-500/30 selection:text-sky-200">
      ...
      <div className="pt-20 relative z-30">
        <WeatherBoard lang={lang} />
      </div>

      {/* Hero Section */}
      <section id="home" className="relative flex flex-col justify-center px-6 min-h-[calc(100vh-5rem)]">
          ...
          <div className="space-y-32">
            {RAW_SOURCES.map((category, catIndex) => (
              <div key={catIndex} id={`category-${catIndex}`} className="scroll-mt-32">
                ...
                {/* GRID FIX: Changed to lg:grid-cols-4 as requested */}
